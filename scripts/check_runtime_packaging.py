...
REQUIRED_PATHS = (
    ...
    ROOT / "deployments/helm/govai-core/Chart.yaml",
    ROOT / "deployments/helm/govai-core/values.yaml",
    ROOT / "deployments/helm/govai-core/templates/deployment.yaml",
    ROOT / "deployments/helm/govai-core/templates/service.yaml",
    ROOT / "deployments/helm/govai-core/templates/pvc.yaml",
    ROOT / "deployments/helm/govai-core/templates/configmap.yaml",
